...
class InteractEventDB(db.Base):
    ...
    def __init__(self, actor_id, user_id, scenary_type, event_type, event_datetime):
    ...
    def as_dict(self):
        return {"user_id": self.user_id, "actor_id": self.actor_id, "scenary_type": self.scenary_type, "event_type": self.event_type, "event_datetime": self.event_datetime}
...
class GameplayEventDB(db.Base):
    ...
    def __init__(self, user_id, scenary_type, event_type, event_datetime):
        self.user_id = user_id
        self.scenary_type = scenary_type
        self.event_type = event_type
        self.event_datetime = event_datetime
    ...
    def as_dict(self):
        return {"user_id": self.user_id, "scenary_type": self.scenary_type, "event_type": self.event_type, "event_datetime": self.event_datetime}
...
class MoveEventDB(db.Base):
    ...
    def __init__(self, user_id, scenary_type, move_type, start_datetime, end_datetime, start_position, end_position, distance):
        self.user_id = user_id
        self.scenary_type = scenary_type
    ...
    def __repr__(self):
        return f'MoveEvent({self.user_id}, {self.scenary_type}, {self.move_type}, {self.start_datetime}, {self.end_datetime}, \
    ...
    def as_dict(self):
        return {"user_id": self.user_id, "scenary_type": self.scenary_type, "move_type": self.move_type, "start_datetime": self.start_datetime, 
                "end_datetime": self.end_datetime, "start_position": self.start_position, "end_position": self.end_position, "distance": self.distance}
